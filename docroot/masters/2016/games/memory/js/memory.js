...
;(function( window ) {
  ...
  Memory.prototype.options = {
    ...
    cards : [
      {
        id : 1,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/azalea.jpg"
          },
          {
            id : 2,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/bigoak.jpg"
          },
          {
            id : 3,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/butlercabin.jpg"
          },
          {
            id : 4,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/clubhouse.jpg"
          },
          {
            id : 5,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/flag.jpg"
          },
          {
            id : 6,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/ikescabin.jpg"
          },
          {
            id : 7,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/magnolia.jpg"
          },
          {
            id : 8,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/mowers.jpg"
          },
          {
            id : 9,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/nelsonbridge.jpg"
          },
          {
            id : 10,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/nicklausplaque.jpg"
          },
          {
            id : 11,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/par3.jpg"
          },
          {
            id : 12,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/pimentocheese.jpg"
          },
          {
            id : 13,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/sarazenbridge.jpg"
          },
          {
            id : 14,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/scoreboard.jpg"
          },
          {
            id : 15,
            img: "http://www.augusta.com/masters/2016/memory/img/landmarks/sign.jpg"
          },
          {
            id : 16,
            img: "http://www.augusta.com/masters/2016/memory/3/7/2016img/landmarks/greenflag.jpg"
      }
    ],
  ...
  Memory.prototype._setupGame = function() {
    ...
    this.gameMetaHTML = '<div class="mg__meta--left">\
      ...
      <button id="mg__button--restart" class="mg__button">Reset</button>\
      </div>';
    this.gameMeta.innerHTML = this.gameMetaHTML;
    this.game.appendChild(this.gameMeta);

    this.gameStartScreenHTML = '<p class="mg__start-screen--text">Flip the tiles to match them in pairs. Pair all tiles to win the game.</p>\
      ...
      <li><span data-level="2">Level 2 - Medium (6 x 3)</span><br></li>\
      <li><span data-level="3">Level 3 - Difficult (8 x 4)</span><br></li>\
      </ul>';
  ...
  Memory.prototype._winGame = function() {
    ...
    if (this.options.onGameEnd() === false) {
      this._clearGame();
      this.gameMessages.innerHTML = '<h2 class="mg__onend--heading">Congrats!</h2>\
        <p class="mg__onend--message">You completed the round in ' + this.numMoves + ' moves.</p>\
