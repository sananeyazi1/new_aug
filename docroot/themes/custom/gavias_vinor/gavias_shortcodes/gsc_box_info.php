...
if(!class_exists('gsc_box_info')):
   class gsc_box_info{
      ...
      public static function sc_box_info( $attr, $content = null ){
         ...
         ?>
            <?php ob_start() ?>
            <div class="widget gsc-box-info <?php print $el_class ?> content-align-<?php print $content_align ?>" style="min-height: <?php print $height; ?>" <?php print gavias_print_animate_aos($animate) ?>>
               <div class="clearfix">
