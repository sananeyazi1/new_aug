...
if(!class_exists('gsc_video_box')):
   class gsc_video_box{
      ...
      ?>
      <?php ob_start() ?>
      <div class="widget gsc-video-box <?php print $el_class;?> clearfix" style="background-image: url('<?php print $image ?>');<?php print $style; ?>" <?php print gavias_print_animate_aos($animate) ?>>
